...
'''
year = 2020
listfiles = sorted(Path('/homedata/nmpnguyen/OPAR/Processed/RF/LIO3T/', year).glob('*RF_v1.nc'))
...
listfiles = sorted(Path('/homedata/nmpnguyen/OPAR/Processed/RF/LI1200/', year).glob('*RF_v1.nc'))
...
axins.annotate(footnote355+'\n'+footnote532,
            ...
            fontsize=10)
ff.tight_layout()
plt.savefig(Path('/homedata/nmpnguyen/OPAR/Processed/RF/', f'distributionSR_100x100_OPAR{year}.png'))
